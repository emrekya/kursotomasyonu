...
<body class="hold-transition skin-blue sidebar-mini">
										...
										<c:if test="${ not empty lsOgrenci }">
											<c:forEach items="${ lsOgrenci }" var="ogr">
												<tr>
													...
													%>
													<td><a
														href='<s:url value="/ogrenciguncelleme/${ ogr.getOgrID() }"></s:url>'
	...
	<script>
		$('#btnTcArama').click(function() {
			...
			//ajax
			$.ajax({
				url : '<s:url value="/ogrencitcara"></s:url>',
				type : "post",
				data : {
					"ogrenciTC" : ogrenciTC
				},
		...
		$('#btnAdiArama').click(function() {
			...
			//ajax
			$.ajax({
				url : '<s:url value="/ogrenciadiara"></s:url>',
				type : "post",
				data : {
		...
		$('#btnSinifArama').click(function() {
			...
			//ajax
			$.ajax({
				url : '<s:url value="/ogrencisinifara"></s:url>',
				type : "post",
