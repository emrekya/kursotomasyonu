						...
						<div class="col-md-6">
							<div class="box box-primary">
									...
									<div class="box-body">
										...
										<button id="btnTcArama"
											class="btn btn-primary pull-right">Arama Yap</button>
									...
									<c:if test="${ not empty personelListesi }">
									  	...
									  	<c:forEach var="personel" items="${ personelListesi }">
											...
											<td><c:out value="${ personel.getPerSira() }"></c:out></td>
												...
												<td><a href='<s:url value="/personelguncelleme/${ personel.getPerID() }"></s:url>' class ="btn btn-warning">Detay</a></td>
												<td><a href='<s:url value="/personelguncelleme/${ personel.getPerID() }"></s:url>' class ="btn btn-warning">Düzenle</a></td>
											</tr>
