...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Kurs</b>Otomasyonu</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Personel Giriş Paneli</p>
	
    <form action="<c:url value='/girisyap'></c:url>" method="post">
      <div class="form-group has-feedback">
        <input name="tcKimlik" type="text" class="form-control" placeholder="TC Kimlik">
